...
<!-- My code starts -->
	...
	<title>Business Plan | Welcome...</title>
    ...
    <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/assets/plugins/flexslider/flexslider.css"/>    	
    <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/assets/plugins/parallax-slider/css/parallax-slider.css"/>
    <!-- CSS Theme -->    
    <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/css/themes/blue.css" id="style_color"/>
    <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/css/themes/headers/header1-blue.css" id="style_color-header-1"/> 
        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">
                    <img id="logo-header" src="<?php echo Yii::app()->request->baseUrl; ?>/assets/img/logo1-blue.png" alt="Logo"/>
                </a>
            </div>
...
<div class="footer">
	<div class="container">
		<div class="row">
			...
			<p class="margin-bottom-25 md-margin-bottom-40">Business Plan is a young organization dedicated to serving the youth and helping them finance their dreams.</p>	

            <!-- Monthly Newsletter -->
		        <div class="headline"><h2>Stay Informed</h2></div>	
				<p>Subscribe to stay updated with changing loan rates and great discount offers</p>
			...
			<div class="col-md-4 md-margin-bottom-40">
                <div class="posts">
                    <div class="headline"><h2>Blog Entries</h2></div>
                    <dl class="dl-horizontal">
                        <dt><a href="#"><img src="<?php echo Yii::app()->request->baseUrl; ?>/assets/img/sliders/elastislide/6.jpg" alt="" /></a></dt>
                        <dd>
                            <p><a href="#">Fixed or Variable rate. That is the question.</a></p> 
                        </dd>
                    </dl>
                    <dl class="dl-horizontal">
                    <dt><a href="#"><img src="<?php echo Yii::app()->request->baseUrl; ?>/assets/img/sliders/elastislide/10.jpg" alt="" /></a></dt>
                        <dd>
                            <p><a href="#">Financing European Education</a></p> 
                        </dd>
                    </dl>
                    <dl class="dl-horizontal">
                    <dt><a href="#"><img src="<?php echo Yii::app()->request->baseUrl; ?>/assets/img/sliders/elastislide/11.jpg" alt="" /></a></dt>
                        <dd>
                            <p><a href="#">What is a collateralised loan and do I need a co-signer?</a></p> 
                        </dd>
                    </dl>
                </div>
			</div><!--/col-md-4-->
...
<div class="copyright">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6">	
				<a href="index.html">
                    <img id="logo-footer" src="<?php echo Yii::app()->request->baseUrl; ?>/assets/img/logo2-default.png" class="pull-right" alt="" />
                </a>
			</div>
		</div><!--/row-->
</div><!--/container-->	
...
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/assets/plugins/jquery-1.10.2.min.js"></script>
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/assets/plugins/jquery-migrate-1.2.1.min.js"></script>
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/assets/plugins/bootstrap/js/bootstrap.min.js"></script> 
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/assets/plugins/hover-dropdown.min.js"></script> 
...
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/assets/plugins/parallax-slider/js/modernizr.js"></script>
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/assets/plugins/parallax-slider/js/jquery.cslider.js"></script> 
<!-- JS Page Level -->           
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/assets/js/app.js"></script>
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/assets/js/pages/index.js"></script>
